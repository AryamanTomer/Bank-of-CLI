...
class AccountServiceTest {
    ...
    @BeforeEach
    void setUp() {
        accountService = new AccountService(accountRepository, transactionRepository, () -> ACCOUNT_ID);
    }
    ...
    void getHistory_returnsRecentTransactions() {
        ...
        when(transactionRepository.findRecentByAccountId(ACCOUNT_ID, AccountService.HISTORY_LIMIT))
